        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url()?>closing/downloadLaporan" method="post" target="_blank">
                <div class="modal-body">
                    ...
                    <div class="form-floating mb-3">
                        <select name="format" class="form form-control form-control-sm required">
                            <option value="">Pilih Format</option>
                            <option value="Bos COD">Bos COD</option>
                            <option value="Mengantar">Mengantar</option>
                        </select>
                        <label class="col-form-label">Format Laporan Ekspedisi</label>
                    </div>
                </div>
...
<div class="modal modal-blur fade" id="laporanAdvertiser" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Laporan Advertiser</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="<?= base_url()?>laporan/laporan_advertiser" method="post" target="_blank">
                <div class="modal-body">
                    <div class="form-floating mb-3">
                        <input type="date" name="tgl_awal" class="form-control form-control-sm">
                        <label class="col-form-label">Tgl Awal</label>
